...
export function WhyAttend({ onRegisterClick }: { onRegisterClick: () => void }) {
  return (
    <section className="py-20 bg-gradient-to-b from-white via-red-50/30 to-white relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-red-300 to-transparent" />
        
        <div className="container mx-auto px-4">
            <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
                  Why Attend This <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-amber-600">Exclusive Event?</span>
                </h2>
            ...
            <div className="flex flex-wrap justify-center gap-8">
                {features.map((feature, index) => (
                    <motion.div
                        ...
                        whileHover={{ y: -10 }}
                        className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 group hover:shadow-2xl transition-all duration-300 w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-2rem)] max-w-[400px] hover:border-red-200"
                    >
                        ...
                        <h3 className="text-xl font-bold text-gray-800 mb-3 group-hover:text-red-600 transition-colors">{feature.title}</h3>
            ...
            <div className="mt-16 text-center">
                <Button 
                    ...
                    className="bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-bold py-7 px-12 text-xl shadow-[0_0_30px_rgba(249,115,22,0.4)] hover:shadow-[0_0_50px_rgba(249,115,22,0.6)] transition-all duration-300 rounded-full transform hover:scale-105"
                >
