...
const categories = [
  { icon: Home, title: "Residential Apartments", color: "from-red-500 to-red-400" },
  { icon: Castle, title: "Villas & Row Houses", color: "from-amber-500 to-amber-400" },
  { icon: Building2, title: "Commercial Spaces", color: "from-red-600 to-amber-500" },
  { icon: Rocket, title: "Pre-Launch Projects", color: "from-amber-600 to-emerald-500" },
  { icon: TrendingUp, title: "High-Rental Yield", color: "from-red-500 to-amber-500" },
  { icon: Gem, title: "Luxury & Ultra-Luxury", color: "from-amber-600 to-red-600" },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-4 text-gray-900">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-amber-600">Property Options Available</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {categories.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-white border-2 border-red-100 p-6 rounded-xl hover:border-red-300 hover:shadow-2xl transition-all cursor-pointer group"
            >
