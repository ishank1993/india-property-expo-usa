...
export function ServicesSection({ onRegisterClick }: ServicesSectionProps) {
  ...
  return (
    <section className="relative py-20 overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-gray-50 via-white to-red-50/30" />
      
      {/* Content */}
      <div className="container mx-auto px-6 relative z-10">
        {/* Header */}
        <div className="text-center max-w-4xl mx-auto mb-16">
          <div className="inline-block bg-gradient-to-r from-red-600 to-amber-600 text-white px-6 py-2 rounded-full text-sm font-bold uppercase mb-6">
            India's Premier Property Exhibition in America
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 leading-tight">
            Your Gateway to <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-amber-600">Verified Premium Properties</span> in India
          </h2>
          <p className="text-xl text-gray-600 leading-relaxed">
            Stop browsing endless listings online. <span className="font-bold text-red-600">Meet India's most trusted developers face-to-face</span> right here in America and explore <span className="font-bold text-amber-600">500+ hand-picked, verified projects</span> across <span className="font-bold text-red-600">35+ prime Indian cities</span>.
          </p>
        ...
        {/* Who Is This For */}
        <div className="bg-gradient-to-r from-red-600 to-amber-600 rounded-3xl p-12 mb-16 shadow-2xl">
          <div className="text-center">
            <h3 className="text-3xl font-bold text-white mb-4">
              🎯 Exclusively for Indians Living in America
            </h3>
            ...
            <p className="text-lg text-white/90 max-w-2xl mx-auto">
              💼 Meet Top Property Developers from across India for personalized 1-on-1 consultations — right here in America
            </p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="text-center mt-8">
            <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-amber-600">
        ...
        {/* Cities Coverage */}
        <div className="mb-16 bg-gradient-to-br from-red-50 to-amber-50 rounded-3xl p-12">
          <h3 className="text-3xl font-bold text-center text-gray-900 mb-10">
            <MapPin className="inline-block w-8 h-8 text-red-600 mr-2 mb-1" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            {cities.map((city, index) => (
              <div 
                key={index}
                className="bg-white rounded-xl px-4 py-3 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 text-center border border-red-100"
              >
        ...
        {/* Special Perks */}
        <div className="bg-gradient-to-r from-red-500 to-amber-600 rounded-3xl p-12 mb-16 shadow-2xl text-center">
        ...
        {/* Final CTA */}
        <div className="text-center bg-gradient-to-br from-gray-900 to-red-900 rounded-3xl p-16 shadow-2xl">
          <h3 className="text-4xl md:text-5xl font-black text-white mb-6">
            Ready to Invest in Your Dream Property?
          </h3>
          <p className="text-xl text-red-200 mb-8 max-w-2xl mx-auto">
            Don't miss this exclusive opportunity to meet India's top developers face-to-face across America
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              onClick={onRegisterClick}
              className="bg-gradient-to-r from-red-500 to-amber-500 hover:from-red-600 hover:to-amber-600 text-white font-bold text-xl px-12 py-7 rounded-full shadow-[0_0_40px_rgba(249,115,22,0.6)] hover:shadow-[0_0_60px_rgba(249,115,22,0.8)] transition-all duration-300 transform hover:scale-105"
            >
